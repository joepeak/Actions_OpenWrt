...
利用Actions云编译，一键生成可直接使用的 OpenWrt固件。

对于Amlogic平台的盒子，所有盒子固件均采用同一底包，默认为打包N1盒子的固件，如需打包其他型号盒子参照flippy的打包脚本说明修改.yml流程文件即可。
...
- [Actions_OpenWrt-Amlogic](https://github.com/quanjindeng/Actions_OpenWrt-Amlogic)
